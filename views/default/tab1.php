		...
		<div align="center">
			<table border="1" width="76%">
				<tr>
					...
					<a target="palco" href="<?php echo  elgg_get_site_url (); ?>mod/moneyagames/views/default/menu1.php">
					MMORG</a></b></font></td>
					...
					<p align="center">
					<font face="Arial" size="5" color="#D9D9D9"><b>
					<a target="palco" href="<?php echo  elgg_get_site_url (); ?>mod/moneyagames/views/default/menu2.php">
					Flash</a></b></font></td>
					...
					<p align="center">
					<font face="Arial" size="5" color="#D9D9D9"><b>
					<a target="palco" href="<?php echo  elgg_get_site_url (); ?>mod/moneyagames/views/default/menu3.php">
					Multiplayer</a></b></font></td>
					...
					<p align="center">
					<font face="Arial" size="5" color="#D9D9D9"><b>
					<a target="palco" href="<?php echo  elgg_get_site_url (); ?>mod/moneyagames/views/default/menu4.php">
					Classic</a></b></font></td>
				</tr>
			</table>
		</div>
...
<IFRAME name=palco src="<?php echo  elgg_get_site_url (); ?>mod/moneyagames/views/default/menu1.php" frameBorder=0 width=100% height=1500px align="center" scrolling="no"></IFRAME></td>
	</tr>
	</table>